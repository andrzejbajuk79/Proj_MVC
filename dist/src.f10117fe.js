...
function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      ...
      var handlers = _this.events[eventName] || []; // dodajemy callback function
...
var axios_1 = __importDefault(require("axios")); // T symbolizuje zbior danych pobieranych za pomoc Axios ktore znajda w JSONie
...
},{"./Eventing":"src/models/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/models/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
exports.ApiSync = ApiSync; // .then((response: AxiosResponse): void => {
...
exports.User = User;
},{"./Collection":"src/models/Collection.ts","./ApiSync":"src/models/ApiSync.ts","./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Eventing":"src/models/Eventing.ts"}],"src/views/View.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  View.prototype.bindModel = function () {
    var _this = this; // blad  poniewaz type T nie koniecznie musi zawierac metode ON, dlatego type T musi zaimplementowac
  ...
  View.prototype.bindEvents = function (fragment) {
    ...
    var _loop_1 = function _loop_1(eventKey) {
      var _a = eventKey.split(':'),
          eventName = _a[0],
          selector = _a[1]; //  w naszym fragmencie HTML probujemy znalezc kazdy element ktory pasuje do SELECTORA
  ...
  View.prototype.onRender = function () {}; // zamieniamy string  na element HTML
...
},{"./UserShow":"src/views/UserShow.ts","./CollectionView":"src/views/CollectionView.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts","./views/UserList":"src/views/UserList.ts"}],"C:/Users/ptasi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/ptasi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
